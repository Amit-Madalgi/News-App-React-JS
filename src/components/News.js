...
export class News extends Component {
  ...
  constructor(props) 
    ...
    async updateNews() {
      ...
      const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=a276b23591124aacbd1ce0f758a07177&page=${this.props.page}&pageSize=${this.props.pageSize}`;
